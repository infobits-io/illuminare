...
/// [IlluminareRenderErrorBox.backgroundColor] static property.
///
...
/// [IlluminareRenderErrorBox.textStyle] and [IlluminareRenderErrorBox.paragraphStyle] static
/// properties.
///
...
class IlluminareRenderErrorBox extends RenderBox {
  ...
  ///
  /// This is intended to ensure that if the [IlluminareRenderErrorBox] is placed at the top left
  ...
  /// The color to use when painting the background of [IlluminareRenderErrorBox] objects.
  ///
  ...
  /// The text style to use when painting [IlluminareRenderErrorBox] objects.
  ///
  ...
  /// The paragraph style to use when painting [IlluminareRenderErrorBox] objects.
